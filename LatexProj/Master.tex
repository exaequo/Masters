...
Tutaj opisuję artykuły? badania?

\chapter{Badanie zdolności przyswajania mechanik gry}
...
Cytat do głównego artykułu: \cite{ArticlePLAY}
...
Badane były osoby, które nigdy wcześniej nie spotkały się z grą będącą obiektem testów. Miały one za zadanie przejść zadane poziomy bez żadnej wcześniejszej informacji o tym, jaki jest chociażby warunek przejścia do następnej planszy. 

Osoba badana informowana była o tym, że jej wyniki są zapisywane dopiero w wtedy, gdy wymagane od niej było, by przystąpiła ponownie do pierwszych pięciu poziomów. Miało to na celu możliwe zminimalizowanie presji czasu, która mogłaby się pojawić przy otrzymaniu aplikacji do testowania.(JAKIŚ LINK?)
